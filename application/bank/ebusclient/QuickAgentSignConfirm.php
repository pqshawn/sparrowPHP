...
class QuickAgentSignConfirm extends TrxRequest {
	public $request = array (
		"TrxType" => IFunctionID :: TRX_TYPE_EBUS_InterfaceAgentSignSubmit_REQ,
		"OrderNo" => "",
		"VerifyCode" => ""
	);
	...
	protected function checkRequest() {
		...
		if (!DataVerifier :: isValid($this->request["VerifyCode"]))
